...
public class StringUtilities {
    ...
    public static String getSuffix(String input){
        if (input.length() > 3 ){
            String userInput = input.substring(input.length() - 3);
            return userInput;
        }
        return input;
    }
    ...
    public static Character getMiddleCharacter(String inputValue) {
        ...
        String value = inputValue.substring(position, position + state);
        char[] middle = value.toCharArray();
        return middle[0];
    ...
    public static String reverse(String stringToReverse){
        StringBuilder reverseWord = new StringBuilder(stringToReverse);
        String result = reverseWord.reverse().toString();
        return result;
    }
}
